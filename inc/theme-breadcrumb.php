...
class Bizmaster_Breadcrumb {
	/**
	 * Array of bread Bizmaster_Breadcrumb
	 *
	 * @var array
	 */
	...
	public function __construct( array $options = [] ) {
		...
		$this->defaults['home'] = esc_html__('Home','bizmaster');
		$this->defaults['blog'] = esc_html__('Blog','bizmaster');
	...
	public function theBreadcrumbs() {
		...
		foreach ( $breadcrumbs as $crumb ) {
			...
			if ( $crumb['url'] ) {
                ...
                $html .= sprintf( '<span>%s</span>', wp_kses($crumb['title'],bizmaster()->kses_allowed_html('all')) );
			}
		...
		echo wp_kses($html,bizmaster()->kses_allowed_html('all'));
	}
	...
	public function getBreadcrumbs() {
		...
		$breadcrumbs = apply_filters( 'bizmaster_get_breadcrumbs', $breadcrumbs );
 ...
 * Template Functions.
 */
if ( ! function_exists( 'bizmaster_breadcrumb' ) ) {
	/**
	 ...
	 * @package bizmaster
	 */
	function bizmaster_breadcrumb( $options = [] ) {
		$Crumbs = new Bizmaster_Breadcrumb( $options );
		$Crumbs->theBreadcrumbs();
	}
}

if ( ! function_exists( 'bizmaster_get_breadcrumbs' ) ) {
	/**
	 ...
	 * @return array
	 */
	function bizmaster_get_breadcrumbs( $options = [] ) {
		$Crumbs = new Bizmaster_Breadcrumb( $options );
 ...
 * Utility functions
 */
if ( ! function_exists( 'bizmaster_breadcrumb_array_insert' ) ) {
	/**
	 ...
	 * @return array
	 */
	function bizmaster_breadcrumb_array_insert( array $array, $element, int $position ) {
