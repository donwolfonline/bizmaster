 ...
 * @since 1.0.0
 * */
global $bizmaster_inline_css;
$backend = bizmaster();
$bizmaster_inline_css = '';
$prefix = 'bizmaster';
ob_start();
...
$page_meta = Bizmaster_Group_Fields_Value::page_container('bizmaster', 'container_options');
...
], '.page-content-inner-' . $page_id . ' .entry-content, .page-content-inner-' . $page_id . ' .entry-content p');
...
$bizmaster_inline_css = ob_get_clean();
