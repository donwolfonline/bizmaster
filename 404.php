...
get_header();
$get_404_options_value = Bizmaster_Group_Fields_Value::get_404_options_value();
					...
					<div class="col-lg-8">
						<div class="error-404 not-found">
							...
							<div class="btn-wrap margin-top-30 text-center d-inline-block">
								<a class="global-btn" href="<?php echo esc_url(home_url('/')); ?>"><?php echo esc_html($get_404_options_value['btn_text']); ?></a>
							</div>
						</div>
					</div>
				</div>
